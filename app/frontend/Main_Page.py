...
class Mainpage():
    def __init__(self):
        ...
        self.app.minsize(width=800, height=400)
    
        ctk.set_appearance_mode("dark")
        ctk.set_default_color_theme("blue")

        self.frame = CTkFrame(master=self.app, fg_color="#01b366", border_color="#FFFFFF", border_width=2,width=700)
        self.frame.pack(expand=False,side = LEFT, fill = Y)

        self.frame2= CTkFrame(master=self.app, fg_color="#383838", border_color="#FFFFFF", border_width=2,width=700)
